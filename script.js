(function () {
  ...
  const items = [
    "🎲",     // dice - roll bonus (rare)
    "💵",     // money - 10/20 pesos (rare)
    "🎯",     // target - jackpot 50 pesos (rare) 
    "🖊️",     // pen - new reward (rare)
    "🫓",     // large chips (uncommon)
    "🫓",     // large chips (uncommon)
    "🥔",     // medium chips (uncommon)
    "🥔",     // medium chips (uncommon)
    "☁️",     // marshmallow (common)
    "☁️",     // marshmallow (common)
    "☁️",     // marshmallow (common)
    "🍬",     // candy (common)
    "🍬",     // candy (common)
    "🍬",     // candy (common)
    "😝",     // reactions (very common - mostly no-win)
    "😂",
    "😭", 
    "😝",
    "😂",
    ...
    "😂",
    "😭", 
    "💸",     // no win symbol (added to increase no-win chance)
    "💸",
    "💸",
  ];
  ...
  async function spin() {
    ...
    if(result[0] == result[1] && result[1] == result[2]){
      ...
      if(result[0] == "💸")
        Swal.fire({
          title: "<span style='font-size: 4em;'>💸💸</span>",
          text: "Kala mo jackpot? Lumipad yung reward!"
        })
      if(result[0] == "😂")
        Swal.fire({
          title: "<span style='font-size: 4em;'>😂😂</span>",
